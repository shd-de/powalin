...
@Serializable
@Suppress("unused")
data class AttributeFilter(override var isInverted: Boolean = false, var operation: FilterOperation = FilterOperation.EQUAL_TO, var isCaseSensitive: Boolean = false) : Filter {
